...
export default class SearchBar extends React.Component {
    ...
    render() {
        ...
        return <div className={Utilities.joinClassNames("bd-searchbar", className, {disabled}, Sizes[size.toUpperCase()] ?? "SMALL")}>
            <input onKeyDown={this.props.onKeyDown} onChange={this.onChange} disabled={disabled} type="text" placeholder={placeholder} maxLength={this.props.maxlength ?? 50} value={this.state.value} />
